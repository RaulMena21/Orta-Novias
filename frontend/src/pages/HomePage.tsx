...
const HomePage: React.FC = () => {
  return (
    <>
      <SEOComponent 
        title="Orta Novias - Vestidos de Novia Exclusivos en Madrid | Diseños Únicos"
        description="Descubre la colección más exclusiva de vestidos de novia en Madrid. Orta Novias ofrece diseños únicos, calidad premium y atención personalizada. Reserva tu cita y encuentra el vestido perfecto para tu día especial."
        keywords="vestidos de novia Madrid, trajes de novia exclusivos, diseños únicos novia, tienda vestidos novia Madrid, vestidos boda, atención personalizada novia"
        type="website"
        image="https://ortanovias.com/images/hero-vestidos-novia.jpg"
      />
      ...
      <div className="min-h-screen">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed">
                    Especializados en <strong className="text-[#8A2E3B]">vestidos de novia en Madrid</strong>, 
                    ofrecemos una amplia gama de estilos: desde <em>vestidos clásicos</em> hasta 
                    <em>diseños vanguardistas</em>. Nuestro equipo de diseñadores y costureras expertas 
                    garantiza que cada <strong>vestido de novia</strong> sea una obra maestra única.
                  </p>
                </div>
                
                {/* Nuevo bloque SEO con palabras clave */}
                <div className="bg-[#FAF7F4] p-6 rounded-lg border-l-4 border-[#D4B483]">
                  <h3 className="text-xl font-semibold text-[#8A2E3B] mb-3">
                    ¿Por qué elegir Orta Novias para tu vestido de novia?
                  </h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="text-[#D4B483] mt-1">•</span>
                      <span><strong>Atención personalizada</strong>: Cita individual con asesora especializada</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#D4B483] mt-1">•</span>
                      <span><strong>Diseños exclusivos</strong>: Colección única no disponible en otras tiendas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#D4B483] mt-1">•</span>
                      <span><strong>Ajustes perfectos</strong>: Taller propio con costureras expertas</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-[#D4B483] mt-1">•</span>
                      <span><strong>Ubicación privilegiada</strong>: En el corazón de Madrid, fácil acceso</span>
                    </li>
                  </ul>
                </div>
        ...
        {/* FAQ Section - SEO Optimizada */}
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-[#8A2E3B] mb-4">
                Preguntas Frecuentes sobre Vestidos de Novia
              </h2>
              <p className="text-lg text-gray-600">
                Resolvemos tus dudas sobre nuestros vestidos de novia en Madrid
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <details className="group">
                  <summary className="flex justify-between items-center p-6 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <h3 className="text-lg font-semibold text-[#8A2E3B]">
                      ¿Cuánto tiempo necesito para elegir mi vestido de novia?
                    </h3>
                    <span className="ml-6 flex-shrink-0 group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="p-6 bg-white">
                    <p className="text-gray-700 leading-relaxed">
                      Recomendamos comenzar la búsqueda de tu <strong>vestido de novia</strong> entre 
                      6-9 meses antes de la boda. Esto permite tiempo suficiente para la selección, 
                      pedido, confección y ajustes necesarios. En Orta Novias, nuestras <em>citas personalizadas</em> 
                      te ayudarán a encontrar el vestido perfecto sin prisas.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <details className="group">
                  <summary className="flex justify-between items-center p-6 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <h3 className="text-lg font-semibold text-[#8A2E3B]">
                      ¿Qué incluye el servicio de ajustes de vestidos de novia?
                    </h3>
                    <span className="ml-6 flex-shrink-0 group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="p-6 bg-white">
                    <p className="text-gray-700 leading-relaxed">
                      Nuestro servicio de <strong>ajustes profesionales</strong> incluye: modificación de talla, 
                      ajuste de largo, adaptación de escote, y modificaciones menores para garantizar 
                      el ajuste perfecto. Contamos con un <em>taller propio</em> con costureras expertas 
                      especializadas en vestidos de novia.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <details className="group">
                  <summary className="flex justify-between items-center p-6 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <h3 className="text-lg font-semibold text-[#8A2E3B]">
                      ¿Dónde está ubicada la tienda Orta Novias en Madrid?
                    </h3>
                    <span className="ml-6 flex-shrink-0 group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="p-6 bg-white">
                    <p className="text-gray-700 leading-relaxed">
                      Nuestra <strong>tienda de vestidos de novia en Madrid</strong> está ubicada en 
                      Calle Gorrión Nº13, en una zona de fácil acceso con transporte público y parking. 
                      Ofrecemos un ambiente elegante y privado para que puedas probarte los vestidos 
                      con total comodidad durante tu <em>cita personalizada</em>.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <details className="group">
                  <summary className="flex justify-between items-center p-6 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <h3 className="text-lg font-semibold text-[#8A2E3B]">
                      ¿Qué tipos de vestidos de novia tienen disponibles?
                    </h3>
                    <span className="ml-6 flex-shrink-0 group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="p-6 bg-white">
                    <p className="text-gray-700 leading-relaxed">
                      En Orta Novias disponemos de una amplia gama de estilos: <strong>vestidos clásicos</strong>, 
                      <strong>vestidos modernos</strong>, <strong>vestidos bohemios</strong>, 
                      <strong>vestidos princesa</strong>, y <strong>vestidos minimalistas</strong>. 
                      Todos nuestros <em>diseños exclusivos</em> están confeccionados con materiales 
                      de la más alta calidad y técnicas artesanales tradicionales.
                    </p>
                  </div>
                </details>
              </div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <details className="group">
                  <summary className="flex justify-between items-center p-6 cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <h3 className="text-lg font-semibold text-[#8A2E3B]">
                      ¿Cómo puedo reservar una cita para ver vestidos de novia?
                    </h3>
                    <span className="ml-6 flex-shrink-0 group-open:rotate-180 transition-transform">▼</span>
                  </summary>
                  <div className="p-6 bg-white">
                    <p className="text-gray-700 leading-relaxed">
                      Puedes <strong>reservar tu cita</strong> de forma sencilla a través de nuestra 
                      web, llamándonos al +34 123 456 789, o escribiéndonos a info@ortanovias.com. 
                      Recomendamos programar la cita con antelación para garantizar la disponibilidad 
                      y recibir una <em>atención completamente personalizada</em>.
                    </p>
                  </div>
                </details>
              </div>
            ...
            <div className="text-center mt-12">
              <Link 
                to="/cita" 
                className="inline-flex items-center gap-2 bg-[#8A2E3B] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#6B1E28] transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <Calendar className="w-5 h-5" />
                Reservar Mi Cita Personalizada
              </Link>
            </div>
          </div>
        </section>
